...
function getDefaultRisks() {
    return [
        ...
        { id: 'RC-04', descripcion: 'Indefinición de fechas de revisión y aprobación para entregables pendientes. La ausencia de un cronograma consensuado con la contraparte para los entregables aún no sometidos puede generar ciclos de retroalimentación no programados que afecten la ruta crítica del proyecto.', categoria: 'Cronograma', disparador: 'Entregables pendientes de presentación sin fecha de revisión confirmada a 5 días del hito planificado', estado: 'En observación' },
        { id: 'RA-01', descripcion: 'Demora en la respuesta administrativa a la solicitud de prórroga del plazo contractual. La ausencia de una resolución definitiva genera incertidumbre en la planificación del cierre del proyecto y condiciona decisiones operativas que dependen del nuevo horizonte temporal.', categoria: 'Contractual', disparador: 'Ausencia de respuesta formal transcurridos 15 días hábiles desde la radicación de la solicitud', estado: 'En seguimiento activo' },
        { id: 'RF-01', descripcion: 'Presión sobre la liquidez operativa por desfase entre ejecución y desembolsos. El pago asociado a la Etapa 2 está condicionado a la aprobación formal de los productos, cuyo proceso puede extenderse más allá del plazo previsto en el flujo de caja. El apalancamiento con recursos propios sostenido en el tiempo puede derivar en un desvío del foco técnico del equipo hacia la gestión financiera. Se sugiere concertar un acuerdo de pago con base en evidencias de avance y el compromiso demostrado en la dinámica del proyecto.', categoria: 'Financiero', disparador: 'Desfase superior a 30 días entre la fecha proyectada de pago y la fecha real de aprobación de los productos de la Etapa 2', estado: 'En observación con impacto creciente' }
    ];
}
